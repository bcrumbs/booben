...
/**
  ...
  */
export const connectDragHandler = (mapStateToPropsWrapped, mapDispatchToPropsWrapped) =>
	WrappedComponent =>
	  	connect(
		    v => Object.assign({},
				mapStateToProps(v),
				mapStateToPropsWrapped ? mapStateToPropsWrapped(v) : {}
			),
	    	v => Object.assign({},
				mapDispatchToProps(v),
				mapDispatchToPropsWrapped ? mapDispatchToPropsWrapped(v) : {}
			)
		)(
			Object.assign(
		      class extends WrappedComponent {
		        constructor(props) {
		          ...
		          this.__handleStartDragComponent
				  	= this.__handleStartDragComponent.bind(this);
